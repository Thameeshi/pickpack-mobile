  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.subtext}>Scan package QR codes to confirm arrival</Text>
        <Text style={styles.subtext}>Camera integration — next phase</Text>
      </View>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  subtext: { fontSize: FONT_SIZES.MD, color: COLORS.GRAY_500, marginTop: SPACING.SM, textAlign: 'center' },
});
