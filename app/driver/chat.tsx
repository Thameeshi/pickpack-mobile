...
export default function DriverChatScreen() {
  ...
  const conversationId =
    user?.uid && supervisorId ? getConversationId(user.uid, supervisorId) : '';
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (supervisorId) {
        createNotification(
          supervisorId,
          `💬 New message from ${profile?.name || 'Driver'}`,
  ...
  const noSupervisor = !supervisorId;
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerCenter}>
          ...
          <View>
            ...
            <Text style={styles.headerSub}>Supervisor</Text>
          </View>
        </View>
        <View style={{ width: 40 }} />
      </View>
      ...
      >
        {noSupervisor ? (
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyTitle}>No supervisor selected</Text>
            <Text style={styles.emptySub}>
              Go back and select a supervisor to start messaging.
            </Text>
          </View>
        ) : loading ? (
